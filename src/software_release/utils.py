...
def load(interface: Type[T], dire: Optional[str] = None) -> None:
    ...
    if not dire:  # set as dir the directory path where the invoking code is
        ...
        dire = os.path.dirname(os.path.realpath(namespace['__file__']))

    project_package_location = os.path.dirname(os.path.realpath(os.path.dirname(os.path.realpath(__file__))))
